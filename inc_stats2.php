...
//All bureaus
$query_bureaus = sprintf("SELECT bureaus_id
		FROM bureaus
		where account_type = 1 and status = 1");
$all_bureaus = mysql_query($query_bureaus, $fiber) or die(mysql_error());
$totalRows_all_bureaus = mysql_num_rows($all_bureaus);
...
?>
            <div class="mws-stat-container clearfix">
                    ...
                    <!-- Statistic Item -->
                	<a class="mws-stat" href="bureaus.php?id=<?php echo $row_best_buy['bureaus_id']; ?>">
                	...
                	<a class="mws-stat" href="bureaus.php?id=<?php echo $row_best_sell['bureaus_id']; ?>">
                    	<!-- Statistic Icon (edit to change icon) -->
                    	<span class="mws-stat-icon icol32-money-<?php echo $_SESSION['MM_activeCurrencyAbbr']; ?>"></span>
                    ...
                    <a class="mws-stat" href="bureaus.php">
                        <!-- Statistic Icon (edit to change icon) -->
                        <span class="mws-stat-icon icol32-user-suit"></span>
                        
                        <!-- Statistic Content -->
                        <span class="mws-stat-content">
                            <span class="mws-stat-title">Available Forex Bureaus</span>
                            <span class="mws-stat-value"><?php echo $totalRows_all_bureaus; ?></span>
                        </span>
                    </a>
